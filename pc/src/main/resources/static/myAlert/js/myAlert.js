(function () {
    $.extend({
        removeModa: function () {
            ...
            var option = {
                title: "提示", message: "程序员太傻，忘记输入提示内容啦……", callback: function () {
                }
            };
            ...
            var top = $(window).height() * 0.3;
            $('body').append('<div class="myModa"><div class="myAlertBox" style="margin-top:' + top + 'px"><h6>' + option.title
                + '</h6><p style="text-align: center">' + option.message + '</p><div class="col2"><div class="btn exit" style="float:left;width:40%;">取消</div>' +
                '<div class="btn" style="float:left;width: 20%;"></div><div class="btn sure" style="float:left;width:40%;">确定</div></div></div></div></div>');
            $('body').css('overflow-y', 'hidden');
